...
public class MyClassLoader extends ClassLoader{
	...
	public static void main( String args[]) {
		...
		try {
            ...
            Class<?> clazz = cl.loadClass(list.get(0).outputStream.toByteArray(),
                    list.get(0).getName());
    ...
    public List<ClassFile> compile(String path, String className) throws FileNotFoundException {
		...
		CompilationTask task = compiler.getTask(null, fileManager, diagnostics, Arrays.asList("-g", "-proc:none", "-classpath", CLASSPATH), null, compilationUnits);
